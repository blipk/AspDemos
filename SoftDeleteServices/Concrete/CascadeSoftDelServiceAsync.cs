...
namespace SoftDeleteServices.Concrete
{
        ...
        where TInterface : class
    {
        ...
        public async Task<IStatusGeneric<int>> SetCascadeSoftDeleteViaKeysAsync<TEntity>(bool skipOneToOneCheck = false, params object[] keyValues)
            where TEntity : class, TInterface
        {
            return await CheckExecuteCascadeSoftDeleteAsync<TEntity>(SetCascadeSoftDeleteAsync, skipOneToOneCheck, keyValues);
        }
        ...
        public async Task<IStatusGeneric<int>> ResetCascadeSoftDeleteViaKeysAsync<TEntity>(bool skipOneToOneCheck = false, params object[] keyValues)
            where TEntity : class, TInterface
        {
            return await CheckExecuteCascadeSoftDeleteAsync<TEntity>(ResetCascadeSoftDeleteAsync, skipOneToOneCheck, keyValues);
        }
        ...
        public async Task<IStatusGeneric<int>> CheckCascadeSoftDeleteViaKeysAsync<TEntity>(bool skipOneToOneCheck = false, params object[] keyValues)
            where TEntity : class, TInterface
        {
            return await CheckExecuteCascadeSoftDeleteAsync<TEntity>( (entity, skipOneToOneCheck, _) => CheckCascadeSoftDeleteAsync(entity, skipOneToOneCheck), skipOneToOneCheck, keyValues);
        }
        ...
        public async Task<IStatusGeneric<int>> HardDeleteSoftDeletedEntriesViaKeysAsync<TEntity>(bool skipOneToOneCheck = false, params object[] keyValues)
            where TEntity : class, TInterface
        {
            return await CheckExecuteCascadeSoftDeleteAsync<TEntity>(HardDeleteSoftDeletedEntriesAsync, skipOneToOneCheck, keyValues);
        }
        ...
        public async Task<IStatusGeneric<int>> SetCascadeSoftDeleteAsync<TEntity>(TEntity softDeleteThisEntity, bool callSaveChanges = true, bool skipOneToOneCheck = false)
            where TEntity : class, TInterface
        {
            if (softDeleteThisEntity == null) throw new ArgumentNullException(nameof(softDeleteThisEntity));
            _context.ThrowExceptionIfPrincipalOneToOne(softDeleteThisEntity, skipOneToOneCheck);
        ...
        public async Task<IStatusGeneric<int>> ResetCascadeSoftDeleteAsync<TEntity>(TEntity resetSoftDeleteThisEntity, bool callSaveChanges = true, bool skipOneToOneCheck = false)
            where TEntity : class, TInterface
        {
        ...
        public async Task<IStatusGeneric<int>> CheckCascadeSoftDeleteAsync<TEntity>(TEntity checkHardDeleteThisEntity, bool skipOneToOneCheck = false)
            where TEntity : class, TInterface
        {
        ...
        public async Task<IStatusGeneric<int>> HardDeleteSoftDeletedEntriesAsync<TEntity>(TEntity hardDeleteThisEntity, bool callSaveChanges = true, bool skipOneToOneCheck = false)
            where TEntity : class, TInterface
        {
        ...
        public async Task<IStatusGeneric<int>> CheckExecuteCascadeSoftDeleteAsync<TEntity>(
            Func<TInterface, bool, bool, Task<IStatusGeneric<int>>> softDeleteAction, bool skipOneToOneCheck = false, params object[] keyValues)
            where TEntity : class, TInterface
        {
            var status = new StatusGenericHandler<int>();
            ...
            return await softDeleteAction(entity, true, skipOneToOneCheck);
        }
