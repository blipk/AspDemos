...
namespace SoftDeleteServices.Concrete.Internal
{
    ...
    {
        public static void ThrowExceptionIfPrincipalOneToOne(this DbContext context, object entityToCheck, bool skipOneToOneCheck = false)
        {
            if (skipOneToOneCheck) return;
